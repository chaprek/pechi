...
<td class="h1right"></td>
 ...
 <?php if ($categories) { ?>
 <div class="box">
 <div class="box-heading-for-category"><?php echo $text_refine; ?></div>
 <div class="box-content-for-category">
 ...
 <?php } ?>
 <div class="name-for-category"><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></div></div>
 <?php } ?>
 </div>
 </div>
 </div>
...
$(document).ready(function() {
	if ($('.category-info')[0].scrollHeight > 165)  {
		...
		$(".category-info").after('<div id="obexpand" class="obertka"><button class="expand" type="button" id="expand"><span class=""><?php echo $text_open; ?></span></button></div>');
		$(".category-info").after('<div id="obhide" class="obertka" style="display:none;"><button class="expand" type="button" id="hide"><span class=""><?php echo $text_close; ?> </span></button></div>');
